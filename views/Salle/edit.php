...
$id = $_GET['id'];
$cons = new Provider();
$edit = $cons->connection()->prepare("SELECT * FROM salle WHERE id = :id");
                    ...
                    <div class="card border-0 shadow rounded-3 my-5">
                        <div class="card-body p-4 p-sm-5">
                            ...
                            <form action="connexion.php" method="POST">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" id="floatingInput" name="place" placeholder="<?php $key->place ?>" required>
