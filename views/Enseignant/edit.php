...
<body>
    ...
    <form action="../../controllers/EnseignantCtrl.php" method="post">
        ...
        <table>
            <tr>
                <td>MATRICULE</td>
                <td><input type="text" name="matricule" readonly value="<?= htmlspecialchars($enseignant['matricule']) ?>" autocomplete="off" required></td>
            </tr>
            <tr>
                <td>NOM</td>
            ...
            <tr>
                <td>EGMAIL</td>
                <td><input type="egmail" name="egmail" value="<?= htmlspecialchars($enseignant['egmail']) ?>" required></td>
            </tr>
            <tr>
                <td>ADDRESSE</td>
                <td><input type="text" name="addresse" value="<?= htmlspecialchars($enseignant['adresse']) ?>" required></td>
            </tr>
            <tr>
