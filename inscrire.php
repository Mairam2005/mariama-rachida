...
<body style="background-image: url(assets/université.jpg);">
  <!-- Navigation-->
        ...
        <div class="card border-0 shadow rounded-3 my-5">
          <div class="card-body p-4 p-sm-5">
            ...
            <form action="connexion.php" method="POST">
              ...
              <div class="form-floating mb-3">
                <input type="email" class="form-control" id="floatingInput" name="email" placeholder="nom@example.com">
              ...
              <div class="d-grid">
                <button class="btn btn-primary btn-login text-uppercase fw-bold" type="submit" name="inscrire"> S'Inscrire </button>
              </div>
              <hr class="my-4">
            </form>
          </div>
